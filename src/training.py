...
class TrainingDataset(object):
    def __init__(self, root, transforms):
        ...
        self.imgs = list(sorted(os.listdir(os.path.join(root, "./training_dataset/training"))))
        self.masks = list(sorted(os.listdir(os.path.join(root, "./training_dataset/mask"))))

    def __getitem__(self, idx):
        # 이미지와 마스크를 읽어옵니다
        img_path = os.path.join(self.root, "./training_dataset/training", self.imgs[idx])
        mask_path = os.path.join(self.root, "./training_dataset/mask", self.masks[idx])
